---
title: Generalized Multipath Path Selection
abbrev: Multipath Path Selection
docname: draft-dawkins-panrg-multipath-selection-latest
date:
category: info
...
ipr: trust200902
area: IRTF
workgroup: PANRG Research Group
keyword: Multipath
keyword: Networking
keyword: Aware
keyword: Path
...
This document is under development in the Github repository at https://github.com/SpencerDawkins/panrg-path-selection.

Readers are invited to open issues and send pull requests with contributed text for this document, but since the document is intended to guide discussion for the Path Aware Networking Research group, substantial discussion of this document should take place on the PANRG mailing list (panrg@irtf.org). Mailing list subscription and archive details are at https://www.irtf.org/mailman/listinfo/panrg.
